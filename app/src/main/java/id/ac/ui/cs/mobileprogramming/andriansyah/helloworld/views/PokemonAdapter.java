...
import id.ac.ui.cs.mobileprogramming.andriansyah.helloworld.databinding.ItemPokemonBinding;
...
//public class PokemonAdapter {
    ...
    static class PokemonAdapterViewHolder extends RecyclerView.ViewHolder {
        ...
        void bindPokemon(Pokemons pokemon) {
            if (binding.getPokemonViewModel() == null) {
                binding.setPokemonViewModel(new ItemPokemonViewModel(itemView.getContext(), pokemon));
            } else {
